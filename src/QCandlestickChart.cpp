...
QCandlestickChart::QCandlestickChart(std::string data_file,
                                     std::string title_series,
                                     std::string title_chart, QWidget *parent)
...
QChartView *QCandlestickChart::get_ChartView() { return this->m_chart_view; }